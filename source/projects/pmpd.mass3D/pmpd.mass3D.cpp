...
struct t_mass3D {
  t_object  x_obj;
  double posX_old_1, posX_old_2, posY_old_1, posY_old_2, posZ_old_1, posZ_old_2;
  double Xinit, Yinit, Zinit, forceX, forceY, forceZ, VX, VY, VZ, dX, dY, dZ;
  double mass3D, seuil, onoff, damp;
