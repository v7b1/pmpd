void pmpd_get(t_pmpd *x, t_symbol *s, int argc, t_atom *argv)
{
    ...
    if ( (toget == gensym("massesPos")) && (argv[1].a_type == A_SYM) )
    {
    ...
    if ( (toget == gensym("massesPosName")) && (argv[1].a_type == A_SYM) )
    {
        for (i=0; i< x->nb_mass; i++)
        {
            if ( atom_getsymbolarg(1,argc,argv) == x->mass[i].Id)
    ...
    if ( (toget == gensym("massesSpeeds")) && (argv[1].a_type == A_SYM) )
    {
        for (i=0; i< x->nb_mass; i++)
        {
            if ( atom_getsymbolarg(1,argc,argv) == x->mass[i].Id)
    ...
    if ( (toget == gensym("massesSpeedsName")) && (argv[1].a_type == A_SYM) )
    {
        for (i=0; i< x->nb_mass; i++)
        {
            if ( atom_getsymbolarg(1,argc,argv) == x->mass[i].Id)
    ...
    if ( (toget == gensym("massesForces")) && (argv[1].a_type == A_SYM) )
    {
        for (i=0; i< x->nb_mass; i++)
        {
            if ( atom_getsymbolarg(1,argc,argv) == x->mass[i].Id)
    ...
    if ( (toget == gensym("massesForcesName")) && (argv[1].a_type == A_SYM) )
    {
        for (i=0; i< x->nb_mass; i++)
        {
            if ( atom_getsymbolarg(1,argc,argv) == x->mass[i].Id)
    ...
    if ( (toget == gensym("linksPos")) && (argv[1].a_type == A_SYM) )
    {
    ...
    if ( (toget == gensym("linksPosName")) && (argv[1].a_type == A_SYM) )
    {
        for (i=0; i< x->nb_link; i++)
        {
            if ( atom_getsymbolarg(1,argc,argv) == x->link[i].Id)
...
//        error("not get attribute");
        object_error((t_object *)x, "not get attribute");
    }
}
